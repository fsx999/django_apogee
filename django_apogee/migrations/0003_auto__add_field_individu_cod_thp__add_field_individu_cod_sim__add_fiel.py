...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Individu.cod_thp'
        db.add_column(u'INDIVIDU', 'cod_thp',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, db_column=u'COD_THP'),
                      keep_default=False)

        # Adding field 'Individu.cod_sim'
        db.add_column(u'INDIVIDU', 'cod_sim',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, db_column=u'COD_SIM'),
                      keep_default=False)

        # Adding field 'Individu.cod_pay_nat'
        db.add_column(u'INDIVIDU', 'cod_pay_nat',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, db_column=u'COD_PAY_NAT'),
                      keep_default=False)

        # Adding field 'Individu.cod_etb'
        db.add_column(u'INDIVIDU', 'cod_etb',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, db_column=u'COD_ETB'),
                      keep_default=False)

        # Adding field 'Individu.cod_uti'
        db.add_column(u'INDIVIDU', 'cod_uti',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, db_column=u'COD_UTI'),
                      keep_default=False)

        # Adding field 'Individu.tem_date_nai_rel'
        db.add_column(u'INDIVIDU', 'tem_date_nai_rel',
                      self.gf('django.db.models.fields.CharField')(default=u'O', max_length=1, null=True, db_column=u'TEM_DATE_NAI_REL'),
                      keep_default=False)

        # Adding field 'Individu.daa_lbt_ind'
        db.add_column(u'INDIVIDU', 'daa_lbt_ind',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, db_column=u'DAA_LBT_IND'),
                      keep_default=False)

        # Adding field 'Individu.dmm_lbt_ind'
        db.add_column(u'INDIVIDU', 'dmm_lbt_ind',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, db_column=u'DMM_LBT_IND'),
                      keep_default=False)

        # Adding field 'Individu.daa_ent_etb'
        db.add_column(u'INDIVIDU', 'daa_ent_etb',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, db_column=u'DAA_ENT_ETB'),
                      keep_default=False)

        # Adding field 'Individu.daa_ens_sup'
        db.add_column(u'INDIVIDU', 'daa_ens_sup',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, db_column=u'DAA_ENS_SUP'),
                      keep_default=False)

        # Adding field 'Individu.daa_etb'
        db.add_column(u'INDIVIDU', 'daa_etb',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, db_column=u'DAA_ETB'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Individu.cod_thp'
        db.delete_column(u'INDIVIDU', u'COD_THP')

        # Deleting field 'Individu.cod_sim'
        db.delete_column(u'INDIVIDU', u'COD_SIM')

        # Deleting field 'Individu.cod_pay_nat'
        db.delete_column(u'INDIVIDU', u'COD_PAY_NAT')

        # Deleting field 'Individu.cod_etb'
        db.delete_column(u'INDIVIDU', u'COD_ETB')

        # Deleting field 'Individu.cod_uti'
        db.delete_column(u'INDIVIDU', u'COD_UTI')

        # Deleting field 'Individu.tem_date_nai_rel'
        db.delete_column(u'INDIVIDU', u'TEM_DATE_NAI_REL')

        # Deleting field 'Individu.daa_lbt_ind'
        db.delete_column(u'INDIVIDU', u'DAA_LBT_IND')

        # Deleting field 'Individu.dmm_lbt_ind'
        db.delete_column(u'INDIVIDU', u'DMM_LBT_IND')

        # Deleting field 'Individu.daa_ent_etb'
        db.delete_column(u'INDIVIDU', u'DAA_ENT_ETB')

        # Deleting field 'Individu.daa_ens_sup'
        db.delete_column(u'INDIVIDU', u'DAA_ENS_SUP')

        # Deleting field 'Individu.daa_etb'
        db.delete_column(u'INDIVIDU', u'DAA_ETB')
