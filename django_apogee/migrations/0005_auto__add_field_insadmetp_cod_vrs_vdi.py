...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InsAdmEtp.cod_vrs_vdi'
        db.add_column(u'INS_ADM_ETP_COPY', 'cod_vrs_vdi',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, db_column=u'COD_VRS_VDI'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InsAdmEtp.cod_vrs_vdi'
        db.delete_column(u'INS_ADM_ETP_COPY', u'COD_VRS_VDI')
