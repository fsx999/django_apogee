...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InsAdmEtp.exoneration'
        db.add_column(u'INS_ADM_ETP_COPY', 'exoneration',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'InsAdmEtp.demi_annee'
        db.add_column(u'INS_ADM_ETP_COPY', 'demi_annee',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InsAdmEtp.exoneration'
        db.delete_column(u'INS_ADM_ETP_COPY', 'exoneration')

        # Deleting field 'InsAdmEtp.demi_annee'
        db.delete_column(u'INS_ADM_ETP_COPY', 'demi_annee')
    ...
    models = {
        ...
        u'django_apogee.indbac': {
            'Meta': {'object_name': 'IndBac', 'db_table': "u'IND_BAC'", 'managed': 'False'},
            ...
            'cod_ind': ('django.db.models.fields.CharField', [], {'max_length': '8', 'primary_key': 'True', 'db_column': "u'COD_IND'"}),
        ...
        u'django_apogee.indopi': {
            ...
            'cod_rgi': ('django.db.models.fields.CharField', [], {'default': "u'1'", 'max_length': '1', 'db_column': "u'COD_RGI'"}),
            ...
            'cod_stu': ('django.db.models.fields.CharField', [], {'default': "u'01'", 'max_length': '2', 'db_column': "u'COD_STU'"}),
