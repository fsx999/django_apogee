...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InsAdmEtp.force_encaissement'
        db.add_column(u'INS_ADM_ETP_COPY', 'force_encaissement',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InsAdmEtp.force_encaissement'
        db.delete_column(u'INS_ADM_ETP_COPY', 'force_encaissement')
